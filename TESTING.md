...
| ID | テスト名 | 結果 | 実行日 |
|----|---------|------|--------|
| TC001 | 初回起動時の生体認証 | ✅ 合格 | 2026-02-06 |
| TC002 | 認証失敗時の動作 | ⏳ 未実施 | - |
| TC003 | 認証キャンセル時の動作 | ⏳ 未実施 | - |
| TC004 | オートロック（30秒） | ✅ 合格 | 2026-02-06 |
| TC005 | スクリーンショット防止 | ⏳ 未実施 | - |

### データ層テスト

| ID | テスト名 | 結果 | 実行日 |
|----|---------|------|--------|
| TC101 | データベース初期化 | ✅ 合格 | 2026-02-06 |
| TC102 | 暗号化・復号テスト | ⏳ 未実施 | - |
...
| ID | テスト名 | 結果 | 実行日 |
|----|---------|------|--------|
| TC201 | パスワード一覧画面の表示 | ✅ 合格 | 2026-02-06 |
| TC202 | LiveDataの監視 | ⏳ 未実施 | - |
